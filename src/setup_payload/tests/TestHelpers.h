...
inline SetupPayload GetDefaultPayloadWithOptionalDefaults()
{
    ...
    payload.addOptionalVendorData(kOptionalDefaultSignedIntTag, kOptionalDefaultSignedIntValue);
    payload.addOptionalVendorData(kOptionalDefaultUnsignedIntTag, kOptionalDefaultUnsignedIntValue);
